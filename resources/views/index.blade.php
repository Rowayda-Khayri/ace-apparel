                        ...
                        <div class="col-md-4">
                                <div class="recent-posts mt-xl">
                                        ...
                                        <article class="post">
                                                ...
                                                <h4 class="pt-md pb-none mb-none"><a class="text-color-dark" href="blogSingle/{{$lastPost->id}}">{{$lastPost->title}}</a></h4>
                                                <p>By {{$lastPost->author}}</p>
                                                <p>{{str_limit("$lastPost->body", 100)}}</p>
                                                <a class="mt-md" href="blogSingle/{{$lastPost->id}}">Read More <i class="fa fa-long-arrow-right"></i></a>
                                        </article>
                                </div>
                        </div>
