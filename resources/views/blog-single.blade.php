...
<html>
	<head>
		...
		<title>Porto - Responsive HTML5 Template 4.9.0</title>	
						...
						<div class="header-row">
							<div class="header-column">
								<div class="header-logo">
                                                                    <img class="logo-default" alt="Porto" width="324" height="212" src="{{ URL::to('/') }}/images/logo-construction.png">
									<a href="index.html">
							...
							<div class="blog-posts single-post mt-xl">
								...
								<article class="post post-large blog-single-post">
									...
									<div class="post-content">
										...
										<h1 class="mb-md">Lorem ipsum dolor sit amet</h1>
